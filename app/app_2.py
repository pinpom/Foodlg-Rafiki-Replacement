...
if __name__ == "__main__":
    ...
    classes = 231
    base_model = InceptionResNetV2(include_top=True, input_shape=(299, 299, 3))
    ...
    clf_model.load_weights("/app/app/models/classification/models/model-zoo/inceptionresnet-food191-0.70.h5")
